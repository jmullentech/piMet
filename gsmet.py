...
credentials = ServiceAccountCredentials.from_json_keyfile_name('PyMet-8b963d95f3cb.json', scope)
gc = gspread.authorize(credentials)
worksheet = gc.open_by_url("https://docs.google.com/spreadsheets/d/1VY2QsYjr_pzsp57OXhjfh_NwlOtRcrr-_wj3_HaXTm8").sheet1
http = httplib2.Http()
